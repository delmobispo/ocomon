<?php 
  ...
  */session_start();
	...
	else
	{
		...
		print "<TR class='header'><td class='line'><b>".TRANS('COL_MANUFACTURE')."</TD><td class='line'><b>".TRANS('COL_SOFT')."</TD><td class='line'><b>".TRANS('COL_VERSION')."</TD><td class='line'><b>".TRANS('CATEGORY')."</TD><td class='line'><b>".TRANS('COL_LICENSE')."</TD><td class='line'><b>".TRANS('BT_REMOVE')."</TD>";
		...
		while ($row = mysql_fetch_array($commit))
		{
			...
			print "<td class='line'><a onClick=\"javascript:confirmaAcao('".TRANS('REMOVE')."; ".$row['fab_nome']." ".$row['soft_desc']."?','".$_SERVER['PHP_SELF']."', 'acao=del&id=".$row['soft_cod']."&comp_inv=".$_GET['comp_inv']."&comp_inst=".$_GET['comp_inst']."&popup=true')\"><img height='16' width='16' src='".ICONS_PATH."drop.png' title='".TRANS('BT_REMOVE')."'></TD>";
			print "</TR>";
		}
