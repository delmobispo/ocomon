...
if ((isset($_GET['LOAD']) && $_GET['LOAD'] != -1)) {
    ...
    $resultadoA = mysql_query($queryA) or die(TRANS('MSG_ERR_GET_DATA') . '<BR>');
...
"<a title='" . TRANS('MSG_REQUIRED_FIELD_ASSET') . "'>" . TRANS('FIELD_TYPE_EQUIP') . ":</a></b>" .
    "</TD>";
...
print "<SELECT class='select' name='comp_tipo_equip' id='idTipo' size='1' " .
    "onChange=\"ajaxFunction('idDivSelItemModel', 'showSelItemModelsIncluir.php', 'idLoad', 'tipo=idTipo');\">";
...
print "<TD width='20%' align='left' bgcolor='" . TD_COLOR . "'><b>" .
"<a title='" . TRANS('MSG_REQUIRED_FIELD_ASSET_MANUFACTURER') . "'>" . TRANS('COL_MANUFACTURE') . ":*</a></b>" .
    "</TD>";
print "<TD width='30%' align='left' bgcolor='" . BODY_COLOR . "'>";
...
print "<TD width='20%' align='left' bgcolor='" . TD_COLOR . "'><b>" .
"<a title='" . TRANS('MSG_REQUIRED_FIELD_ASSET_TAG') . "'>" .
"" . TRANS('ASSET_TAG') . "*:</a></b></TD>";
...
print "<TR>";
print "<TD width='20%' align='left' bgcolor='" . TD_COLOR . "'><b>" .
"<a title='" . TRANS('MSG_REQUIRED_FIELD_ASSET_MODEL') . "'>" . TRANS('COL_MODEL') . "*:</a></b></TD>";
print "<TD width='30%' align='left' bgcolor='" . BODY_COLOR . "'>";

print "<div id='idDivSelItemModel'>";
...
print "<TD width='20%' align='left' bgcolor='" . TD_COLOR . "'><b>" .
"<a title='" . TRANS('MSG_REQUIRED_FIELD_DEPARTMENT') . "'>" .
"" . TRANS('DEPARTMENT') . "*:</a></b></TD>";
...
"title='" . TRANS('MSG_LOAD_MODEL_HARDWARE') . "'>" .
...
print "<TR>";
print "<TD width='20%' align='left' bgcolor='" . TD_COLOR . "'><b>" .
"<a title='" . TRANS('MSG_REQUIRED_FIELD_ASSET_STATE') . "'>" . TRANS('STATE') . "*:</a></b></TD>";
print "<TD width='30%' align='left' bgcolor='" . BODY_COLOR . "'>";
...
print "<td width='20%' bgcolor='" . TD_COLOR . "'><b>" . TRANS('TO_ATTACH_IMAGE') . "</b></td>";
...
print "<TD width='20%' align='left' bgcolor='" . TD_COLOR . "'><b>" . TRANS('MOTHERBOARD') . ": </b></TD>";
print "<TD width='30%' align='left' bgcolor='" . BODY_COLOR . "'>";
...
print "<tr>";
print "<TD width='20%' align='left' bgcolor='" . TD_COLOR . "'><b>" . TRANS('PROCESSOR') . ": </b></TD>";
print "<TD width='30%' align='left' bgcolor='" . BODY_COLOR . "'>";
...
print "<TD width='20%' align='left' bgcolor='" . TD_COLOR . "'><b>" . TRANS('CARD_MEMORY') . ": </b></TD>";
print "<TD width='30%' align='left' bgcolor='" . BODY_COLOR . "'>";
...
print "<TR>";
print "<TD width='20%' align='left' bgcolor='" . TD_COLOR . "'><b>" . TRANS('CARD_VIDEO') . ": </b></TD>";
print "<TD width='30%' align='left' bgcolor='" . BODY_COLOR . "'>";
...
print "<TD width='20%' align='left' bgcolor='" . TD_COLOR . "'><b>" . TRANS('CARD_SOUND') . ": </b></TD>";
print "<TD width='30%' align='left' bgcolor='" . BODY_COLOR . "'>";
...
print "<TR>";
print "<TD width='20%' align='left' bgcolor='" . TD_COLOR . "'><b>" . TRANS('CARD_NETWORK') . ": </b></TD>";
print "<TD width='30%' align='left' bgcolor='" . BODY_COLOR . "'>";
...
print "<TD width='20%' align='left' bgcolor='" . TD_COLOR . "'><b>" . TRANS('CARD_MODEN') . ": </b></TD>";
print "<TD width='30%' align='left' bgcolor='" . BODY_COLOR . "'>";
...
print "<TD width='20%' align='left' bgcolor='" . TD_COLOR . "'><b>" . TRANS('DVD') . ": </b></TD>";
print "<TD width='30%' align='left' bgcolor='" . BODY_COLOR . "'>";
...
print "<TR>";
print "<TD width='20%' align='left' bgcolor='" . TD_COLOR . "'><b>" .
"<a title='" . TRANS('MSG_REQUIRED_FIELD_OWNER_UNIT') . "'>" . TRANS('COL_UNIT') . "*:</a>" . "
				</b></TD>";
print "<TD width='30%' align='left' bgcolor='" . BODY_COLOR . "'>";
...
print "<TD width='20%' align='left' bgcolor='" . TD_COLOR . "'><b>" . TRANS('COST_CENTER') . ": </b></TD>";
print "<TD width='30%' align='left' bgcolor='" . BODY_COLOR . "'>";
...
print "<TD width='20%' align='left' bgcolor='" . TD_COLOR . "'><b>" . TRANS('PURCHASE_DATE') . "*:</b></TD>";
print "<TD width='30%' align='left' bgcolor='" . BODY_COLOR . "'><INPUT type='text' class='text' name='comp_data_compra' id='idDataCompra'></TD>";
print "</tr>";

print "<TR>";
print "<TD width='20%' align='left' bgcolor='" . TD_COLOR . "'><b>" . TRANS('FIELD_TYPE_WARRANTY') . ": </b></TD>";
print "<TD width='30%' align='left' bgcolor='" . BODY_COLOR . "'>";
...
print "<TR>";
print "<TD colspan='2'  align='right' bgcolor='" . BODY_COLOR . "'><input type='submit' value='" . TRANS('BT_RECORD') . "' name='submit' " .
"class='button' title='" . TRANS('BT_RECORD') . "'>";
print "</TD>";
...
if (isset($_POST['submit'])) {
	...
	$comp_inv = noHtml($_POST['comp_inv']);
	$comp_inst = noHtml($_POST['comp_inst']);

    if (!empty($_POST['comp_sn'])) {
        ...
        $linhasSN = mysql_num_rows($resultadoSN);
        if ($linhasSN > 0) {
    ...
    if (!$erro) {
        ...
        if ($gravaImg) {
            ...
            if ($exec == 0) {
                $aviso .= TRANS('MSG_NOT_ATTACH_IMG') . "<br>";
            }
		...
		//$data = $hoje;
		$comp_valor = "";
		if (isset($_POST['comp_valor']) && !empty($_POST['comp_valor'])){
...
//                 $comp_data_compra = datam($_POST['comp_data_compra']);
        ...
        "VALUES (". dbField($_POST['comp_inv'],'text') .",'" . noHtml($_POST['comp_sn']) . "',". dbField($_POST['comp_marca']) ."," .
        "". dbField($_POST['comp_mb']) .", ". dbField($_POST['comp_proc']) .",". dbField($_POST['comp_memo']) .",". dbField($_POST['comp_video']) ."," .
        "". dbField($_POST['comp_som']) .", ". dbField($_POST['comp_rede']) .", ". dbField($_POST['comp_modelohd']) .", " .
        "". dbField($_POST['comp_modem']) .", ". dbField($_POST['comp_cdrom']) .", ". dbField($_POST['comp_dvd']) .", " .
        "". dbField($_POST['comp_grav']) .",'" . noHtml($_POST['comp_nome']) . "', '" . $_POST['comp_local'] . "', " .
        "". dbField($_POST['comp_fornecedor']) .",'" . noHtml($_POST['comp_nf']) . "','" . noHtml($_POST['comp_coment']) . "', " .
        "'" . date("Y-m-d H:i:s") . "', " . (!empty($comp_valor) ? $comp_valor : 'null') . ", " . dbField($_POST['comp_data_compra'],"date") . ", " .
            "'" . $_POST['comp_inst'] . "', ". dbField($_POST['comp_ccusto']) .", '" . $_POST['comp_tipo_equip'] . "', " .
            "". dbField($_POST['comp_tipo_imp']) .", ". dbField($_POST['comp_resolucao']) .", ". dbField($_POST['comp_polegada']) .", " .
            "". dbField($_POST['comp_fab']) .", '" . $_POST['comp_situac'] . "', ". dbField($_POST['comp_tipo_garant']) .", " .
            "". dbField($_POST['comp_garant_meses']) ." " .
            ")";
        $resultado = mysql_query($query) or die(TRANS('MSG_ERR_SAVE_RECORD') . '<br>' . $query);
        if ($resultado == 0) {
    ...
    print "<script>mensagem('" . $aviso . "'); " .
        "redirect('equipment_show.php?tag=" . $_POST['comp_inv'] . "&unit=" . $_POST['comp_inst'] . "');" .
        "</script>";
...
<script type='text/javascript'>
		...
		$(window).on('load', function() {
            ...
            // ajaxFunction('idDivSelItemModel', 'showSelItemModelsIncluir.php', 'idLoad');
	...
	function valida(){
		...
		if (ok) var ok = validaForm('idEtiqueta','ALFANUM','<?php print TRANS('ASSET_TAG');?>',1);
		...
		if (ok) var ok = validaForm('idSituac','COMBO','<?php print TRANS('STATE');?>',1);
		if (ok) var ok = validaForm('idUnidade','COMBO','<?php print TRANS('COL_UNIT');?>',1);
		if (ok) var ok = validaForm('idValor','MOEDASIMP','<?php print TRANS('FIELD_EQUIP_VALUE');?>',0);
		if (ok) var ok = validaForm('idDataCompra','DATA','<?php print TRANS('PURCHASE_DATE');?>',0);
