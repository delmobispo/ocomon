<?php 
  ...
  */session_start();
	...
	print "<tr><td width='100%' align='left'><b>".TRANS('DOCS_ASSOC_MODEL_EQUIP')."</b></td></tr>";
	...
	if ($linhas == 0) {
		...
		print "<TR>";
			print "<TD bgcolor='".$cor1."'><b>".TRANS('DOCUMENT')."</b></TD>";
			print "<TD bgcolor='".$cor1."'><b>".TRANS('LOCALIZATION')."</b></TD>";
