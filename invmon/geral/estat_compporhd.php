...
print "<TABLE border='0' cellpadding='5' cellspacing='0' class='center' width='50%' bgcolor='" . $cor3 . "'>";
print "<tr><td class='line'></TD></tr>";
print "<tr><td class='line'></TD></tr>";
print "<tr><td width='80%' align='center'><b>" . TRANS('TTL_QTD_COMP_FOR_HD') . "<p>" . TRANS('COL_UNIT') . ": " . $msgInst . ".</p></b></td></tr>";
...
print "<TR><TD bgcolor='" . $cor3 . "'><b>" . TRANS('MNL_CAD_EQUIP') . "</TD><TD bgcolor='" . $cor3 . "'><b>" . TRANS('MNL_HD') . "</TD><TD bgcolor='" . $cor3 . "'><b>" . TRANS('COL_QTD') . "</TD><TD bgcolor='" . $cor3 . "'><b>" . TRANS('PERCENTAGE') . "</TD></tr>";
...
while ($row = mysql_fetch_array($resultado)) {
    ...
    print "<TD bgcolor='" . $color . "'><a href='equipments_list.php?comp_tipo_equip=" . $row['tipo'] . "&comp_modelohd=" . $row['tipo_hd'] . "&ordena=local,etiqueta' title='" . TRANS('HNT_LIST_COMP_CAD_MODEL_HD') . "'>" . $row['hd'] . "</a></TD>";
