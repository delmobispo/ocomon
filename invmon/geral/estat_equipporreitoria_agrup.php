<?php 
  ...
  */session_start();
	...
	$cab = new headers;
	$cab->set_title(TRANS(".TRANS('TTL_OCOMON')."));
	...
	print "<TABLE border='0' cellpadding='5' cellspacing='0' align='center' width='80%' bgcolor='".$cor3."'>";
		...
		print "<TABLE border='0' cellpadding='5' cellspacing='0' align='center' width='80%' bgcolor='".$cor3."'>";
		print "<TR><TD bgcolor='".$cor3."'><b>".TRANS('COL_RECTORY')."</TD><TD bgcolor='".$cor3."'><b>".TRANS('COL_QTD')."</TD><TD bgcolor='".$cor3."'><b>".TRANS('PERCENTAGE')."</TD></tr>";
		$i=0;
		$j=2;
		...
		while ($row = mysql_fetch_array($resultado)) {
			...
			$j++;
			print "<TR>";
			print "<TD bgcolor='".$color."'><a href='equipments_list.php?comp_tipo_equip=".$row['tipo']."&comp_reitoria=".$row['cod_reitoria']."&ordena=modelo,etiqueta' title='".TRANS('HNT_LIST_EQUIP_CAD_FOR_TYPE_LOCAL')."'>".$row['reitoria']."</TD>";
