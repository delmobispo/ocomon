  ...
  */session_start();
	...
	print "<TABLE border='0' cellpadding='5' cellspacing='0' align='center' width='80%' bgcolor='".$cor3."'>";
		...
		while ($row = mysql_fetch_array($resultado)) {
			...
			$j++;
			print "<TR>";
			print "<TD bgcolor='".$color."'><a href='equipments_list.php?comp_tipo_equip=".$row['tipo']."&comp_reitoria=".$row['cod_reitoria']."&ordena=modelo,etiqueta' title='Exibe a listagem de equipamentos cadastrados desse tipo para esse local.'>".$row['reitoria']."</TD>";
		...
		print "<tr><td width='80%' align='center'><b>Sistema em desenvolvimento pelo setor de Helpdesk  do <a href='https://ocomonphp.sourceforge.io/' target='_blank'>Unilasalle</a>.</b></td></tr>";
		print "</TABLE>";
