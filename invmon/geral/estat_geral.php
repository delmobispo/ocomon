  ...
  */session_start();
	...
	if (isset($_POST['checkprint'])){
		...
		print "<div id='Layer2' style='position:absolute; left:80%; top:70px; width:15%; height:40%; z-index:2; ".$div_hide." '>";//  <!-- Ver: overflow: auto    não funciona para o Mozilla-->
			...
			print "<br><input type='submit' class='button' value='".TRANS('BT_APPLY')."' name='OK'>";
		...
		//Tabela de quantidade de equipamentos cadastrados por dia
			...
			print "<br/><br/><p class='center bold'>".TRANS('TTL_ESTAT_CAD_EQUIP')."</p><br/>";
			print "<p class='center bold'>".TRANS('COL_UNIT').": $msgInst</p><br/>";


			print "<fieldset class='center'><legend>".TRANS('TTL_GENERAL_BOARD')."</legend>";
			print "<TABLE border='0' cellpadding='5' cellspacing='0' class='center' width='60%' bgcolor='".$cor3."'>";
			print "<TR><TD bgcolor='".$cor3."'><b>".TRANS('MNL_VIS_EQUIP')."</TD><TD bgcolor='".$cor3."'><b>".TRANS('COL_QTD')."</TD><TD bgcolor='".$cor3."'><b>".TRANS('PERCENTAGE')."</TD></tr>";
			$i=0;
			$j=2;
		...
		while ($row = mysql_fetch_array($resultado)) {
			...
			$j++;
			print "<TR>";
			print "<TD bgcolor='".$color."'><a href='equipments_list.php?comp_tipo_equip=".$row['tipo']."&ordena=fab_nome,modelo,local,etiqueta' title='".TRANS('HNT_LIST_EQUIP_THIS_TYPE')."'>".$row['Equipamento']."</a></TD>";
        	...
        	print "<TR><TD bgcolor='".$cor3."'><b>".TRANS('TOTAL')."</TD><TD bgcolor='".$cor3."'><font color='red'><b>$total</font></TD><TD bgcolor='".$cor3."'><b>".TRANS('100_PERCENT')."</TD></tr>";
		print "</TABLE>";
		...
		$msgInst= "".TRANS('COL_UNIT').": ".$msgInst;

		if (!$hide_buttom) {
			print "<br/><p class='center'><input type='button' class='button' value='".TRANS('BT_GRAPH')."' onClick=\"return popup('graph_geral_barras.php?".$valores."&".$nome."&instituicao=".$msgInst."')\"></p>";
