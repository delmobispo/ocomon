...
<?php 
        ...
        while ($i < $linhas)
        {
                ...
                ?>
                <TR>
                <TD bgcolor=<?php print $color;?>><a href=equipment_show.php?comp_inv=<?php print mysql_result($resultado,$i,1);?>&comp_inst=<?php print mysql_result($resultado,$i,9);?>><?php print mysql_result($resultado,$i,1);?></a></TD>
                ...
                <td bgcolor=<?php print $color;?>><a href=equipment_show.php?comp_inv=<?php  print mysql_result($resultado,$i,7);?>><?php  print mysql_result($resultado,$i,7);?></a>
