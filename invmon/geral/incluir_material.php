...
<TABLE border="0"  align="left" width="50%" bgcolor=<?php print BODY_COLOR?>>
        ...
        <TR>
                <TD width="30%" align="left" bgcolor=<?php print TD_COLOR?>><?php print $TRANS["stored_in_the_box"]?>:</TD>
	...
	<?php // TRADUZIR//?>	
        ...
        <TR>
                <BR>
                <TD align="right" width="20%" bgcolor=<?php print BODY_COLOR?>><input type="submit" value="<?php print $TRANS["bt_cad"]?>" name="ok">
                        <input type="hidden" name="rodou" value="sim">
                </TD>
                <TD align="center" width="80%" bgcolor=<?php print BODY_COLOR?>><INPUT type="reset" value="<?php print $TRANS["bt_cancel"]?>" onClick="javascript:redirect('inventory_main.php')"></TD>
        </TR>
        ...
        <?php 
                if ($rodou == "sim")
                {
                        ...
                        if ($erro == "não")
                        {
                                ...
                                {
                                        $aviso = $TRANS["msg_data_include_ok"]."!";
                                }
                        }
