...
//----------------TABELA  -----------------//
print "<br/><br/><p class='center bold'>" . TRANS('TTL_PREVIEWS_EXP_GUARANTEE_FULL') . ": <a href='estat_vencimentos.php'>" . TRANS('SHOW_ONLY_3_YEARS') . "</a></p>";
print "<br/><table cellspacing='0' border='1' class='center' >";
