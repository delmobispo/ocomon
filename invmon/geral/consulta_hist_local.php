<?php 
  ...
  */session_start();
	...
	print "<BR><B>".TRANS('GET_ASSETS_BY_OLD_PLACE_OR_PERIOD').":</font></font></B><BR>";
...
// 	print "<TR>";
// 		print "<TD width='20%' align='left' bgcolor='".TD_COLOR."'><b>".TRANS('START_DATE').":</b></TD>";
// 		print "<TD colspan='3' align='left' bgcolor='".BODY_COLOR."'>".
// 				"<input type='text' class='text' disabled name='dInicio' size='10'></TD>";
// 	print "</tr>";
// 	print "<TR>";
// 		print "<TD width='20%' align='left' bgcolor='".TD_COLOR."'><b>END_DATE:</b></TD>";
// 		print "<TD colspan='3'  align='left' bgcolor='".BODY_COLOR."'>".
...
// 	print "</tr>";
	...
	NL(4);
	print "<TR>";
		print "<TD bgcolor='".BODY_COLOR."'><input type='submit' class='button' value='".TRANS('SEARCH')."' name='ok'>";
		print "</TD>";
...
<!--
	...
	function valida(){
		...
		var ok = validaForm('idComp_local','COMBO','<?php print TRANS('LOCALIZATION');?>',1);
