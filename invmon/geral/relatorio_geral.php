...
<?php 
 ...
 $query = "SELECT c.comp_inv as etiqueta, c.comp_sn as serial, c.comp_nome as nome, 
        ...
        if ($linhas>1){
				...
				print "<TR>";
				print "<td witdh='600' align='left'><P STYLE=page-break-before: always><FONT FACE=Arial, sans-serif><FONT SIZE=2 STYLE=font-size: 9pt><b>InvMon - Relatório Geral de equipamentos cadastrados - Total de equipamentos: $linhas.</b>\t<a href=relatorios.php>[ Outros relatórios ]</a>.\t<a href=inventory_main.php>[ Início ]</a></FONT></FONT></P></td>";
