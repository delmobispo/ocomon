  ...
  */session_start();
	...
	print "<TABLE border='0' cellpadding='5' cellspacing='0' align='center' width='60%' bgcolor='".$cor3."'>";
		...
		print "<tr><td width='60%' align='center'><b>".TRANS('TTL_QTD_EQUIP_FOR_DAY').":</b></td></tr>";
        	...
        	print "<td class='line'>";
        	print "<fieldset><legend>".TRANS('RECORDS_BY_DAY')."</legend>";
		print "<TABLE border='0' cellpadding='5' cellspacing='0' align='center' width='60%' bgcolor='".$cor3."'>";
        	print "<TR><TD bgcolor='".$cor3."'><b>".TRANS('DATE')."</TD><TD bgcolor='".$cor3."'><b>".TRANS('COL_QTD')."</TD></tr>";
		$i=0;
		$j=2;
		...
		while ($rowC = mysql_fetch_array($resultadoC)) {
			...
			print "<TD bgcolor='".$color."'><a href='equipments_list.php?comp_data=".$searchDate."&ordena=equipamento,modelo,local,etiqueta'>".$rowC['DIA']."/".$rowC['MES']."/".$rowC['ANO']."</a></TD>";
