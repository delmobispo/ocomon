<?
  ...
  */session_start();
	...
	print "<tr><td ><b>".TRANS('DATE')."</b></td><td ><b>".TRANS('COL_AMOUNT')."</b></td><td ><b>".TRANS('COL_TYPE')."</b></td><td ><b>".TRANS('COL_MODEL_2')."</b></td></tr>";
	//-----------------FINAL DA TABELA  -----------------------//
	...
	while ($row=mysql_fetch_array($result)) {
		...
		print "<tr><td ><a onClick=\"popup('equipments_list.php?VENCIMENTO=".$vencimento1."')\">".$vencimento."</a></td>".
			"<td align='center'><a onClick=\"popup('equipments_list.php?VENCIMENTO=".$vencimento1."')\">".$row['quantidade']."</a></td>".
			"<td >".$row['tipo']."</td><td >".$row['fabricante']." ".$row['modelo']."</td></tr>";
	} // while
	print "<tr><td ><b>".TRANS('TOTAL')."</b></td><td colspan='3'><b>".$tt_garant."</b></td></tr>";
	print "</table><br><br>";
