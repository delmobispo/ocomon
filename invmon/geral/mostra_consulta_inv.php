			...
			while ($row = mysql_fetch_array($resultado)) {
				...
				geraLog(LOG_PATH.'invmon.txt',date ("d-m-Y H:i:s"),$_SESSION['s_usuario'],$_SERVER['PHP_SELF'],$texto);
					...
					if ($_SESSION['s_ocomon']==1){
						print "<td  width='10%' align='center'>
							<br><B><a onClick= \"javascript: popup_alerta('ocorrencias.php?popup=true&comp_inv=".$row['etiqueta']."&comp_inst=".$row['cod_inst']."')\" title='".TRANS('HNT_OCCO_EQUIP')."'>".TRANS('TICKETS')."</a></B><br>
							</td>";
					}
					...
					print "<td width='10%' align='center'><br><B><a class='botao' ".
							...
							"&comp_inst=".$row['cod_inst']."')\" title='".TRANS('HNT_HISTORY_LOCAL_EQUIP')."'>".TRANS('DEPARTMENTS')."</a></B><br>";
					print "</td>";
					print "<td width='10%'  align='center'><br><B><a class='botao' ".
					...
					print "<td width='10%'  align='center'><br><B><a class='botao' ".
							...
							"title='".TRANS('DOCS_ASSOC_MODEL_EQUIP')."'>".TRANS('LINK_DOCUMENTS')."</a></B><br>";
					print "</td>";

					if ($_SESSION['s_invmon']==1){
						print "<td width='10%'  align='center'>
							<br><B><a class='botao' href='altera_dados_computador.php?comp_inv=".$row['etiqueta']."&comp_inst=".$row['cod_inst']."'>".TRANS('BT_ALTER')."</a></B><br>
							</td>";
					}
					print "</tr>";
					print "</table>";
					...
					print "<table width='100%'>";
					print "<tr><TD colspan='4' align='left'><br><B>".TRANS('GENERAL_DATA').":</B></td></tr></table>";
				}
				...
				print "<tr>";
                		...
                		print "<TD class='borda' width='30%' align='left' >".
                				"<a href='equipments_list.php?comp_tipo_equip=".$row['tipo']."'".
                				" title='".TRANS('LIST_ALL_ASSETS_OF_THIS_TYPE')." ".$row['equipamento']." ".TRANS('HNT_CAD_IN_SYSTEM')."'>".$row['equipamento']."</a>".
                			"</TD>";
                		print "<TD width='20%' align='left' bgcolor='".TD_COLOR."'><b>".TRANS('COL_MANUFACTURE').":</b></TD>";
                		print "<TD class='borda' width='30%' align='left' >".
                				"<a href='equipments_list.php?comp_fab=".$row['fab_cod']."'".
                				" title='".TRANS('HNT_LIST_EQUIP_MANUF')." ".$row['fab_nome']." ".TRANS('HNT_CAD_IN_SYSTEM')."'>".$row['fab_nome']."</a>".
                			"</TD>";
    				print "</tr>";
				print "<tr>";
                		print "<TD width='20%' align='left' bgcolor='".TD_COLOR."'><b>".TRANS('ASSET_TAG').":</b></TD>".
                			"<TD class='borda' width='30%' align='left' >".$row['etiqueta']."</TD>".
                			"<TD width='20%' align='left' bgcolor='".TD_COLOR."'><b>".TRANS('SERIAL_NUMBER').":</b></TD>".
				...
				print "<tr>";
                		print "<TD width='20%' align='left' bgcolor='".TD_COLOR."'><b>".TRANS('COL_MODEL').":</b></TD>".
                			"<TD class='borda' width='30%' align='left' ><a href='equipments_list.php?".
                				"comp_marca=".$row['modelo_cod']."' title='".TRANS('HNT_LIST_EQUIP_MODEL')." ".$row['modelo']."  ".TRANS('HNT_CAD_IN_SYSTEM')."'>".$row['modelo']."</a>".
                			"</TD>";
				print "<TD width='20%' align='left' bgcolor='".TD_COLOR."'><b>".TRANS('DEPARTMENT').":</b></TD>".
                			"<TD class='borda' width='30%' align='left' ><a href='equipments_list.php?".
				...
				print "<tr>";
				print "<TD  width='20%' align='left' bgcolor='".TD_COLOR."'><b>".TRANS('STATE').":</b></TD>";
				print "<TD  class='borda' width='30%' align='left' ><a href='equipments_list.php?".
				...
				if (($row['tipo']==1) or ($row['tipo']==2) or ($row['tipo']==12)or ($row['tipo']==16)) {
					...
					print "<TD class='borda' width='30%' align='left' ><a href='equipments_list.php?comp_mb=".$row['cod_mb']."' ".
					...
					print "<TD class='borda' width='30%' align='left' ><a href='equipments_list.php?comp_video".
					...
					print "<TD width='20%' align='lef't bgcolor='".TD_COLOR."'><b>".TRANS('CARD_SOUND').":</b></TD>";
					print "<TD class='borda' width='30%' align='left' ><a href='equipments_list.php?".
					...
					print "<TD class='borda' width='30%' align='left' ><a href='equipments_list.php?".
							"comp_modelohd=".$row['cod_hd']."' title='HNT_LIST_EQUIP_HARDDISK ".$row['fabricante_hd']." ".TRANS('SHORT_OF')." ".$row['hd_capacidade']." ".$row['hd_sufixo']." ".TRANS('HNT_CAD_IN_SYSTEM')."'>".$row['fabricante_hd']." ".$row['hd']." ".$row['hd_capacidade']." ".$row['hd_sufixo']."</a>".
						"</TD>";
				...
				while ($rowPiece = mysql_fetch_array($execQryPieces)){
					...
					print "<TD class='borda' width='30%' align='left' >".
						//"<a href='equipments_list.php?piece=".$rowPiece['estoq_desc']."'>".
				...
				print "<TR>";
				print "<TD width='20%' align='left' bgcolor='".TD_COLOR."'><b>".TRANS('COL_UNIT').":</b></TD>";
				print "<TD class='borda' width='30%' align='left' ><a href='equipments_list.php?".
				...
				print "</tr>";
				print "<TR>";
				print "<TD width='20%' align='left' bgcolor='".TD_COLOR."'><b>".TRANS('COL_RECTORY').":</b></TD>";
				print "<TD class='borda' width='30%' align='left' ><a href='equipments_list.php?".
				...
				print "</TR>";
				print "<TR>";
				print "<TD width='20%' align='left' bgcolor='".TD_COLOR."'><b>".TRANS('TECHNICAL_ASSISTANCE').":</b></TD>";
				print "<TD class='borda' width='30%' align='left' ><a href='equipments_list.php?".
				...
				while ($rowTela2 = mysql_fetch_array($execTela2)) {
					$cont++;
					print "<tr>";
					print "<TD  width='20%' bgcolor='".TD_COLOR."' >".TRANS('ATTACHMENT')." ".$cont.":</td>";
				...
				while ($rowTela = mysql_fetch_array($execTela)) {
					$cont++;
					print "<tr>";
					print "<TD  width='20%' bgcolor='".TD_COLOR."' >".TRANS('ATTACHMENT')." <a onClick= \"javascript:popup_alerta('../../ocomon/geral/ticket_show.php?popup=true&numero=".$rowTela['img_oco']."')\"><font color='blue'>".$rowTela['img_oco']."</font></a>:</td>";
