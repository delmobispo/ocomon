...
print "<TABLE border='0' cellpadding='5' cellspacing='0' align='center' style='margin:auto;' width='80%' bgcolor='" . $cor3 . "'>";
...
print "<td class='line'>";
print "<fieldset><legend>" . TRANS('TOP_TEN') . "</legend>";
print "<TABLE border='0' cellpadding='5' cellspacing='0' align='center' width='80%'>";
print "<TR><TD><b>" . TRANS('COL_RANKING') . "</TD>" .
"<TD><b>" . TRANS('MNL_CAD_EQUIP') . "</TD>" .
"<TD><b>" . TRANS('COL_MODEL') . "</TD>" .
"<TD><b>" . TRANS('COL_QTD') . "</TD>" .
"<TD><b>" . TRANS('PERCENTAGE') . "</TD></tr>";
$i = 1;
$j = 2;
while ($row = mysql_fetch_array($resultado)) {
    ...
    print "<TD class='line'>" . $i++ . ".º</TD>";
    print "<TD class='line'>" . $row['equipamento'] . "</TD>";
    print "<TD class='line'><a href='equipments_list.php?comp_marca=" . $row['tipo_modelo'] . "&ordena=fab_nome,modelo,local,etiqueta' title='" . TRANS('HNT_SHOW_EQUIP_MODEL_CAD_SYSTEM') . "'>" . $row['fabricante'] . " " . $row['modelo'] . "</TD>";
