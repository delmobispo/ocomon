  ...
  */session_start();
	...
	$query = "SELECT ".
			...
			"FROM ".
				...
				"left join {$table} as eqp on eqp.eqp_piece_id = e.estoq_cod ".
...
// 		print $query."<br>";
		...
		$resultado = mysql_query($query) or die( TRANS('MSG_ERR_GET_DATA')."<br>".$query);
	...
	if ((!isset($_GET['action'])) && (empty($_POST['submit']) || $_POST['submit'] == TRANS('BT_SEARCH')) ) {
		...
		if (mysql_num_rows($resultado) == 0){
			...
			echo mensagem(TRANS('NO_RECORDS_FOUND'));
			print "</td>";
			print "</tr>";
			...
			print "<TR class='header'><td class='line'>".TRANS('COL_TYPE')."</TD><td class='line'>".TRANS('COL_MODEL')."</TD>".
					"<td class='line'>".TRANS('SERIAL_NUMBER')."</TD><td class='line'>".TRANS('COL_PARTNUMBER')."</TD>".
					"<td class='line'>".TRANS('DEPARTMENT')."</TD><td class='line'>".TRANS('COL_EQUIP','Equipamento')."</TD>".
					"<td class='line'>".TRANS('BT_ALTER')."</TD>".
					"<td class='line'>".TRANS('BT_REMOVE')."</TD>";
			$j=2;
			while ($row = mysql_fetch_array($PAGE->RESULT_SQL))
			{
				...
				$link = "";
				if (!empty($row['eqp_equip_inv']) && $row['instEquipamento']!= '-1') {
					$link = "<a onClick=\"popup('equipment_show.php?comp_inv=".$row['eqp_equip_inv']."&comp_inst=".$row['eqp_equip_inst']."')\">".NVL($row['instEquipamento']." - ".$row['eqp_equip_inv'])."</a>";
				}

				print "<td class='line'>" . $link . "</td>";
				print "<td class='line'><a onClick=\"popup_alerta('".$_SERVER['PHP_SELF']."?action=alter&cod=".$row['estoq_cod']."&cellStyle=true&popup=true')\"><img height='16' width='16' src='".ICONS_PATH."edit.png' title='".TRANS('BT_ALTER')."'></a></td>";
				print "<td class='line'><a onClick=\"confirmaAcao('".TRANS('MSG_DEL_REG')."','".$_SERVER['PHP_SELF']."', 'action=excluir&cod=".$row['estoq_cod']."')\"><img height='16' width='16' src='".ICONS_PATH."drop.png' title='".TRANS('BT_REMOVE')."'></a></TD>";
...
/*			print "<select class='select' name='estoque_desc' id='idDesc'>";
		...
		print "</TD>";
        	...
        	print "<TR>";
               	print "<TD width='20%' align='left' bgcolor='".TD_COLOR."'>".TRANS('SERIAL_NUMBER').":</TD>";
		print "<TD  align='left' bgcolor='".BODY_COLOR."'><INPUT type='text' class='text' name='estoque_sn' id='idSN'></TD>";
        	print "</TR>";

        	print "<TR>";
                print "<TD width='20%' align='left' bgcolor='".TD_COLOR."'>".TRANS('DEPARTMENT').":</TD>";
                print "<TD  align='left' bgcolor='".BODY_COLOR."'>";
		...
		print "</TD>";
        	...
        	print "<TR>";
               	print "<TD width='20%' align='left' bgcolor='".TD_COLOR."'>".TRANS('ASSET_TAG','Etiqueta').":</TD>";
		...
		print "<TD  align='left' bgcolor='".BODY_COLOR."'><INPUT type='text' class='text' name='estoque_value' id='idValue'></TD>";
        	...
        	print "<TR>";
               	print "<TD width='20%' align='left' bgcolor='".TD_COLOR."'>".TRANS('PURCHASE_DATE').":</TD>";
		print "<TD  align='left' bgcolor='".BODY_COLOR."'><INPUT type='text' class='text' ".$readOnlyDateField." name='estoque_date_buy' id='idDatebuy' autocomplete='off'>".
			"</TD>";
        	print "</TR>";
		...
		print "</TD>";
        	...
        	print "<TR>";
                print "<TD width='20%' align='left' bgcolor='".TD_COLOR."'>".TRANS('COST_CENTER','Centro de custo').":</TD>";
                print "<TD  align='left' bgcolor='".BODY_COLOR."'>";
			print "<select class='select' name='estoque_ccusto' id='idCcusto'>";
			print "<option value=null selected>".TRANS('COST_CENTER')."</option>";
			$select = "select * from " . TB_CCUSTO . " order by descricao";
			$exec = mysql_query($select);
			while($row = mysql_fetch_array($exec)){
		...
		print "</TD>";
        	...
        	print "<TR>";
                print "<TD width='20%' align='left' bgcolor='".TD_COLOR."'>".TRANS('STATE','Situação').":</TD>";
                print "<TD  align='left' bgcolor='".BODY_COLOR."'>";
			print "<select class='select' name='estoque_situac' id='idSituac'>";
			print "<option value=null selected>".TRANS('STATE')."</option>";
		...
		NL(2); //new line
		print "<tr>";
		print "<TD align='left' width='20%' bgcolor='".BODY_COLOR."'><input type='submit' class='button' value='".TRANS('BT_RECORD')."' name='submit'>";
		print "</TD>";
	...
	if ((isset($_GET['action']) && $_GET['action']=="alter") && empty($_POST['submit'])) {
		...
		print "<TR>";
                print "<TD width='20%' align='left' bgcolor='".TD_COLOR."' valign='top'>".TRANS('DESCRIPTION').":</TD>";
                print "<TD  align='left' bgcolor='".BODY_COLOR."'>";
...
// 			print "</select>";
		...
		print "<TR>";
                print "<TD width='20%' align='left' bgcolor='".TD_COLOR."' valign='top'>".TRANS('SERIAL_NUMBER').":</TD>";
                print "<TD  align='left' bgcolor='".BODY_COLOR."'>";
		...
		print "<TR>";
                print "<TD width='20%' align='left' bgcolor='".TD_COLOR."' valign='top'>".TRANS('LOCALIZATION').":</TD>";
                print "<TD  align='left' bgcolor='".BODY_COLOR."'>";
			print "<select class=select name='estoque_local' id='idLocal'>";
		...
		//print "<TD  align='left' bgcolor='".BODY_COLOR."'><INPUT type='text' class='text' name='estoque_date_buy' id='idDatebuy' value='".$row['estoq_data_compra']."'></TD>";
			print "<TD  align='left' bgcolor='".BODY_COLOR."'><INPUT type='text' class='text' ".$readOnlyDateField." name='estoque_date_buy' id='idDatebuy' value='".formatDate($row['estoq_data_compra'], 1)."' datecomplete='off'>".
			"</TD>";
		...
		print "</TD>";
        	...
        	print "<TR>";
                ...
                print "<TD  align='left' bgcolor='".BODY_COLOR."'>";
			print "<select class='select' name='estoque_ccusto' id='idCcusto'>";
			print "<option value=null>".TRANS('COST_CENTER')."</option>";
			$select = "select * from " . TB_CCUSTO . " order by descricao";
			$exec = mysql_query($select);
			while($rowS = mysql_fetch_array($exec)){
		...
		print "</TD>";
        	...
        	print "<TR>";
                ...
                print "<TD  align='left' bgcolor='".BODY_COLOR."'>";
			print "<select class='select' name='estoque_situac' id='idSituac'>";
			print "<option value=null>".TRANS('STATE')."</option>";
			$select = "select * from situacao order by situac_nome";
			$exec = mysql_query($select);
			while($rowS = mysql_fetch_array($exec)){
		...
		print "</tr>";
        	...
        	print "<TR>";
                print "<TD width='20%' align='left' bgcolor='".TD_COLOR."'>".TRANS('TECHNICIAN').":</TD>";
                print "<TD  align='left' bgcolor='".BODY_COLOR."'>";
	...
	if ((isset($_GET['action']) && $_GET['action']=="details") && empty($_POST['submit'])) {
		...
		print "<TR>";
                print "<TD class='default'  width='20%' align='left' bgcolor='".TD_COLOR."' valign='top'>".TRANS('DESCRIPTION').":</TD>";
                print "<TD  align='left' bgcolor='".BODY_COLOR."'>".$row['fabricante']." ".$row['modelo']." ".$row['capacidade']." ".$row['sufixo']."</td>";
		print "</tr>";

		print "<TR>";
                print "<TD class='default'  width='20%' align='left' bgcolor='".TD_COLOR."' valign='top'>".TRANS('SERIAL_NUMBER').":</TD>";
                print "<TD  align='left' bgcolor='".BODY_COLOR."'>".$row['estoq_sn']."</td>";
		print "</tr>";

		print "<TR>";
                print "<TD class='default'  width='20%' align='left' bgcolor='".TD_COLOR."' valign='top'>".TRANS('LOCALIZATION').":</TD>";
		...
		print "</tr>";
        	...
        	print "<TR>";
               	print "<TD class='default'  width='20%' align='left' bgcolor='".TD_COLOR."'>".TRANS('ASSET_TAG','Etiqueta').":</TD>";
		...
		print "</tr>";
        	...
        	print "<TR>";
               	print "<TD class='default'  width='20%' align='left' bgcolor='".TD_COLOR."'>".TRANS('PURCHASE_DATE','Data da compra').":</TD>";
                print "<TD align='left' bgcolor='".BODY_COLOR."'>".formatDate($row['estoq_data_compra'], 1)."</td>";
		...
		print "</tr>";
        	...
        	print "<TR>";
                print "<TD class='default'  width='20%' align='left' bgcolor='".TD_COLOR."'>".TRANS('COST_CENTER','Centro de custo').":</TD>";
                print "<TD  align='left' bgcolor='".BODY_COLOR."'>".$row['ccusto']."</td>";
		print "</tr>";

        	print "<TR>";
                print "<TD class='default'  width='20%' align='left' bgcolor='".TD_COLOR."'>".TRANS('STATE','Situação').":</TD>";
	...
	if ($_POST['submit'] == TRANS('BT_RECORD')){
...
// 		$linhas = mysql_num_rows($resultadoCad);
//
// 		if ($linhas > 0)
// 		{
...
// 		}
		...
		if (!$erro)
		{
			...
			$valor = (!empty($_POST['estoque_value']) ? str_replace(",",".",$_POST['estoque_value']) : 'null');
			...
			$query = "INSERT INTO estoque (estoq_tipo, estoq_desc, estoq_local, estoq_sn, estoq_tag_inv, estoq_tag_inst, ".
					...
					"".$_POST['estoque_situac'].", ". $dateBuy .", ".$_POST['estoque_ccusto'].", ".
					"".$_POST['estoque_vendor'].", '".noHtml($_POST['estoque_partnumber'])."', ".
					"'".noHtml($_POST['estoque_comentario'])."')";

			//print $query; exit;

			$resultadoNew = mysql_query($query) or die (TRANS('MSG_ERR_SAVE_RECORD').'<BR>'.$query);
			if ($resultadoNew == 0)
			{
				$aviso = TRANS('MSG_ERR_SAVE_RECORD');
			}
			else
			{
			...
			if (isset($_POST['estoque_equip_unidade']) && !empty($_POST['estoque_equip_unidade']) && isset($_POST['estoque_equip_tag']) && !empty($_POST['estoque_equip_tag'])){
				$qryInsertEquip = "INSERT INTO {$table} (eqp_piece_id, eqp_equip_inv, eqp_equip_inst) ".
						"values ('".$PIECE_ID."', '".$_POST['estoque_equip_tag']."', '".$_POST['estoque_equip_unidade']."')";
				$execInsertEquip = mysql_query ($qryInsertEquip) or die(TRANS('MSG_ERR_DATA_UPDATE').'<br>'.$qryInsertEquip);
				...
				$execUpdHist = mysql_query($qryUpdHistorico) or die (TRANS('MSG_ERR_SAVE_RECORD')."<BR>".$qryUpdHistorico);
...
// 		} else $erro = false;
		...
		if (!$erro) {
			...
			$query = "UPDATE estoque SET estoq_tipo = ".$_POST['estoque_tipo']." , estoq_desc = '".noHtml($_POST['estoque_desc'])."', ".
						...
						"estoq_data_compra = " . $dateBuy . ", estoq_warranty = ".$_POST['estoque_warranty'].",  ".
			...
			$resultadoUpd = mysql_query($query) or die (TRANS('MSG_ERR_DATA_UPDATE').'<BR>'.$query);
			if ($resultadoUpd == 0)
			{
			...
			if (isset($_POST['estoque_equip_unidade']) && !empty($_POST['estoque_equip_unidade']) && isset($_POST['estoque_equip_tag']) && !empty($_POST['estoque_equip_tag'])){
				$sqlChecaEquip = "SELECT * FROM {$table} WHERE eqp_piece_id = ".$_POST['cod']." "; //".$row['estoq_cod']."
				$execChecaEquip = mysql_query($sqlChecaEquip) or die(TRANS('MSG_ERR_DATA_UPDATE').'<br>'.$sqlChecaEquip);
				$achou = mysql_num_rows($execChecaEquip);
				if ($achou) {//update
					$qryUpdEquip = "UPDATE {$table} SET eqp_equip_inv = '".noHtml($_POST['estoque_equip_tag'])."', ".
							"eqp_equip_inst = '".$_POST['estoque_equip_unidade']."' ".
							"WHERE eqp_piece_id = ".$_POST['cod']."";
					$execUpdEquip = mysql_query($qryUpdEquip) or die(TRANS('MSG_ERR_DATA_UPDATE').'<br>'.$qryUpdEquip);
				} else { //insert
					$qryInsertEquip = "INSERT INTO {$table} (eqp_piece_id, eqp_equip_inv, eqp_equip_inst) ".
...
<script type="text/javascript">
	function valida(){
		...
		if (ok) var ok = validaForm('idLocal','COMBO','<?php print TRANS('DEPARTMENT');?>',1);
