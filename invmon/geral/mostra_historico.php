<?php 
  ...
  */session_start();
        ...
        if ($linhas == 0)
	{
        ...
        if ($linhas>1){
                $texto = TRANS('DEPARTMENTS');//Perfumaria: Apenas imprime o nome da coluna no plural se existirem mais de um local no histórico.
		print "<table border='0' cellspacing='1' summary=''";
		print "<TR>";
		print "<TD colspan='3' align='left' ><B>".TRANS('WERE_FOUND')." ".$linhas." ".TRANS('TXT_REG_OF_LOCALIZATION_FOR_EQUIP')."</B></TD>";
		print "</tr>";
		print "</table>";
		print "<tr><p><TD bgcolor='".$cor1."'><b>".TRANS('ASSET_TAG').":\t</b>".$row['etiqueta']."</TD></tr><br>";
		print "<tr><TD bgcolor='".$cor1."'><b>".TRANS('COL_UNIT').":\t</b>".$row['instituicao_nome']."</TD></tr><br>";
		print "<tr><TD bgcolor='".$cor1."'><b>".TRANS('FIELD_TYPE_EQUIP').":</b>\t".$row['equipamento']."</TD></tr><br></p>";

	}
	else {
		$texto = TRANS('DEPARTMENT');
	...
	print "</TD>";
        ...
        print "<TR class='header'><td class='line'><b>".$texto."</TD><td class='line'><b>".TRANS('DATE')."</TD>";
        $i=0;
        $j=2;
	...
	while ($row = mysql_fetch_array($resultado2)) {
		...
		$j++;
		if ($i==0) {
			$atualmente = "<font ".$alerta.">[".TRANS('CURRENT_DEPARTMENT')."]</font>";  //Perfumaria: Serve para identificar para o usuário o local atual onde o equipamento está!!!
		} else
			$atualmente = '';

		print "<tr class=".$trClass." id='linhax".$j."' onMouseOver=\"destaca('linhax".$j."','".$_SESSION['s_colorDestaca']."');\" onMouseOut=\"libera('linhax".$j."','".$_SESSION['s_colorLinPar']."','".$_SESSION['s_colorLinImpar']."');\"  onMouseDown=\"marca('linhax".$j."','".$_SESSION['s_colorMarca']."');\">";
		print "<td class='line'><a ".$alerta." onClick= \"javascript: window.opener.location.href='equipments_list.php?comp_local=".$row['local_cod']."&comp_tipo_equip=".$row['tipo']."&ordena=fab_nome,modelo,local,etiqueta'\">".$row['locais']." </a><b><font color='green'>".$atualmente."</font></b></td>";
