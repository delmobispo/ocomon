...
if ($linhas > 1) {
    if (isset($_REQUEST['visualiza']) && $_REQUEST['visualiza'] == 'impressora') {
        ...
        print "<TR><TD bgcolor='" . TD_COLOR . "'><B>" . TRANS('WERE_FOUND') . " <font color='red'>" . $linhas . "</font> " . TRANS('TXT_REG_ORDER_BY') . " <u>" . $traduzOrdena . "</u>: </B></TD></TR>";
    ...
    if (isset($_REQUEST['visualiza']) && $_REQUEST['visualiza'] == 'texto') {
        print "<TR><TD bgcolor='" . TD_COLOR . "'><B><a href='inventory_main.php'>OcoMon</a> - " . TRANS('FIELD_FORMAT_EXPORT') . ".\t</B></TD></TR><br>";
        print "<tr><TD bgcolor='" . TD_COLOR . "'><i>" . TRANS('FIELD_CRITE_EXIBIT') . ": " . $texto . ".</i></td></tr><br><br>";
        print "<TR><TD bgcolor='" . TD_COLOR . "'><B>" . TRANS('WERE_FOUND') . " <font color=red>" . $linhas . "</font> " . TRANS('TXT_REG_ORDER_BY') . " <u>" . $traduzOrdena . "</u>: </B></TD></TR>";
        print "<TR><TD bgcolor='" . TD_COLOR . "'><B><a href='consulta_comp.php'>[ " . TRANS('LINK_NEW_REPORT') . " ]</a>.</B></TD></TR>";
        ...
        //if ($avanca==$TRANS["all"]) {$top=$linhasTotal;} else$top=$min+($max-1);
        print "<TD width='750' align='left' ><B>" . TRANS('WERE_FOUND') . " <font color='red'>" . $linhasTotal . "</font> " . TRANS('TXT_REG_ORDER_BY') . " <u>" . $traduzOrdena . "</u>. " . TRANS('TXT_SHOW_OF') . " <font color='red'>" . $min . "</font> " . TRANS('THE') . " <font color='red'>" . $top . "</font>.</B></TD>";
...
} else //APENAS 1 REGISTRO
{
    ...
    if (isset($_REQUEST['visualiza']) && $_REQUEST['visualiza'] == 'texto') {
        print "<TR><TD bgcolor='" . TD_COLOR . "'><B><a href='inventory_main.php'>OcoMon</a> - <u>" . TRANS('FIELD_FORMAT_EXPORT') . ".</u>\t</B></TD></TR><br>";
        print "<tr><TD bgcolor='" . TD_COLOR . "'><i>" . TRANS('FIELD_CRITE_EXIBIT') . ": " . $texto . ".</i></td></tr><br><br>";
        print "<TR><TD bgcolor='" . TD_COLOR . "'><B>" . TRANS('FOUND_ONE') . " <font color='red'>1</font> " . TRANS('TXT_CAD_REG_SYSTEM') . ": </B></TD></TR>";
        print "<TR><TD bgcolor='" . TD_COLOR . "'><B><a href='consulta_comp.php'>[ " . TRANS('LINK_NEW_REPORT') . " ]</a>.</B></TD></TR>";
    } else { //Visualização normal na tela do sistema!!
...
} else ####### Mostra Consulta normal na tela principal do sistema!!
{
    ...
    "<TD class='line' valign='middle'><b><a onClick=\"redirect('" . $_SERVER['PHP_SELF'] . "?ordena=etiqueta&coluna=etiqueta&ordenado=" . $ordenado . "&" . $param . "')\" title='" . TRANS('HNT_ORDER_BY_TAG') . ".'>" . TRANS('ASSET_TAG') . "</a>" . $ICON_ORDER['etiqueta'] . "</TD>" .
    "<td class='line'><b><a onClick=\"redirect('" . $_SERVER['PHP_SELF'] . "?ordena=instituicao,etiqueta&coluna=instituicao&ordenado=" . $ordenado . "&" . $param . "')\" title='" . TRANS('HNT_ORDER_BY_UNIT') . "'.>" . TRANS('COL_UNIT') . "</a>" . $ICON_ORDER['instituicao'] . "</TD>" .
    ...
    "<td class='line'><b><a onClick=\"redirect('" . $_SERVER['PHP_SELF'] . "?ordena=local&coluna=local&ordenado=" . $ordenado . "&" . $param . "')\" title='" . TRANS('HNT_ORDER_BY_LOCAL') . "'>" . TRANS('LOCALIZATION') . "</a>" . $ICON_ORDER['local'] . "</TD>" .
    "<td class='line'><b><a onClick=\"redirect('" . $_SERVER['PHP_SELF'] . "?ordena=situac_nome&coluna=situacao&ordenado=" . $ordenado . "&" . $param . "')\" title='" . TRANS('HNT_ORDER_BY_SITUAC') . "'>" . TRANS('STATE') . "</a>" . $ICON_ORDER['situacao'] . "</TD>";
    if ($_SESSION['s_invmon'] == 1) {
        print "<td class='line'><b>" . TRANS('BT_ALTER') . "</TD>";
    }

    if ($administrador) {
        print "<td class='line'><b>" . TRANS('BT_REMOVE') . "</TD>";
    }
    $i = 0;
    $j = 2;
    $cont = 0;
    while ($row = mysql_fetch_array($resultado)) {
        ...
        //print "<td class='line'><a ".$alerta." onClick=\"montaPopup('equipment_show.php?comp_inv=".$row['etiqueta']."&comp_inst=".$row['cod_inst']."')\" title='".TRANS('HNT_SHOW_DATEIL_EQUIP_CAD')."'>".$row['etiqueta']."</a></TD>";
        print "<td class='line'><a " . $alerta . " onClick=\"exibeEscondeImg('idTr" . $j . "'); exibeEscondeImg('idDivLinha" . $j . "'); ajaxFunction('idDivLinha" . $j . "', 'equipment_show.php', 'idLoad', 'comp_inv=idEtiqueta" . $j . "', 'comp_inst=idUnidade" . $j . "' , 'INDIV=idINDIV');\"  title='" . TRANS('HNT_SHOW_DATEIL_EQUIP_CAD') . "'>" . $row['etiqueta'] . "</a></TD>";
    ...
    if ($linhas > 5) { //Colocar rodapé se a quantidade de registros for maior do que 20 registros.
        ...
        print "<TR>";
        $min++;
        if (isset($avancaTodos)) {$top = $linhasTotal;} else {
            $top = $min + ($max - 1);
        }
