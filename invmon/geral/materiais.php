<?php 
  ...
  */session_start();
	...
	$traduz = array("mat_cod" => $TRANS["col_code"],
		"mat_nome"=> $TRANS["description"],
		"mat_caixa" =>$TRANS["col_box"],
	...
	$resultado = mysql_query($query);
        ...
        else
        {
				...
				print "<TD width='224' align='left' ><input  type='submit' $stilo name='avanca' value='<<' title='Visualiza os $max primeiros registros.'> <input  type='submit' $stilo name='avanca' value='<' title='Visualiza os $max registros anteriores.'> <input  type='submit' $stilo name='avanca' value='>' title='Visualiza os próximos $max registros.'> <input  type='submit' $stilo name='avanca' value='>>' title='Visualiza os últimos $max registros.'> <input  type='submit' $stilo2 name='avanca' value=".$TRANS["all"]." title='Visualiza todos os $linhasTotal registros.'></td>";
				print "</tr>";
				print "</form>";
                print "</table>";
