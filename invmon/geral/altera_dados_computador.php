  ...
  */session_start();
	...
	print "<TABLE border='0'  align='left' width='100%'>";
		...
		print "<tr>";
			...
			//LOCALIZAÇÃO
			print "<TD width='20%' align='left' bgcolor='".TD_COLOR."'>".TRANS('LOCALIZATION').":</TD>";
		...
		print "<tr>";
			//SITUAÇÃO
			print "<TD width='20%' align='left' bgcolor='".TD_COLOR."'>".TRANS('STATE').":</TD>";
			...
			print "<TD width='20%' align='left' bgcolor=".TD_COLOR.">".TRANS('TO_ATTACH_IMAGE').":</TD>";
		...
		print "<tr>";
			...
			//MB
			print "<TD width='20%' align='left' bgcolor='".TD_COLOR."'>".TRANS('MOTHERBOARD').":</TD>";
		...
		print "<tr>";
			//PROCESSADOR
			print "<TD width='20%' align='left' bgcolor='".TD_COLOR."'>".TRANS('PROCESSOR').":</TD>";
			...
			//MEMÓRIA
			print "<TD width='20%' align='left' bgcolor='".TD_COLOR."'>".TRANS('CARD_MEMORY').":</TD>";
		...
		print "<tr>";
			//PLACA DE VÍDEO
			print "<TD width='20%' align='left' bgcolor='".TD_COLOR."'>".TRANS('CARD_VIDEO').":</TD>";
			...
			//PLACA DE SOM
			print "<TD width='20%' align='left' bgcolor='".TD_COLOR."'>".TRANS('CARD_SOUND').":</TD>";
			...
			//PLACA DE REDE
			print "<TD width='20%' align='left' bgcolor='".TD_COLOR."'>".TRANS('CARD_NETWORK').":</TD>";
			...
			print "<tr>";
			//PLACA DE FAX/MODEM
			print "<TD width='20%' align='left' bgcolor='".TD_COLOR."'>".TRANS('CARD_MODEN').":</TD>";
		...
		print "<tr>";
			...
			print "</TD>";
			//DVD
			print "<TD width='20%' align='left' bgcolor='".TD_COLOR."'>".TRANS('DVD').":</TD>";
		...
		print "<tr>";
			...
			//CENTRO DE CUSTO
			print "<TD width='20%' align='left' bgcolor='".TD_COLOR."'>".TRANS('COST_CENTER').":</TD>";
		...
		print "<tr>";
			//TIPO GARANTIA
			print "<TD width='20%' align='left' bgcolor='".TD_COLOR."'>".TRANS('FIELD_TYPE_WARRANTY').":</TD>";
		...
		print "<tr>";
			print "<TD width='20%' align='left' bgcolor='".TD_COLOR."'>".TRANS('ASSISTENCE').":</TD>";
			print "<TD width='30%' align='left' bgcolor='".BODY_COLOR."'>";
		...
		print "</Tr>";
			...
			//if ($isTela !=0) {
				...
				print "<TD  bgcolor='".TD_COLOR."' >".TRANS('ATTACHMENT')."  ".$cont." ".TRANS('TXT_THE_INVEN').":</td>";
	...
	if (isset($_POST['submit']))
	{
		...
		if (!$erro)
		{
			...
			$query = "UPDATE equipamentos SET comp_sn='".noHtml($_POST['serial'])."', comp_marca='".$_POST['modelo']."', comp_mb=". dbField($_POST['mb']) .",
						...
						comp_resolucao=". dbField($_POST['scanner']) .", comp_polegada=". dbField($_POST['monitor']) .", comp_fab=". dbField($_POST['fabricante']) .",
						comp_situac=". dbField($_POST['situacao']) .", comp_tipo_garant=". dbField($_POST['tipo_garantia']) .",
						comp_garant_meses=". dbField($_POST['tempo_meses']) .", comp_assist=". dbField($_POST['comp_assist']) ."
