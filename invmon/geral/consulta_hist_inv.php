...
<!--
	...
	function valida(){
		var ok = validaForm('idComp_inv','INTEIRO','<?php print TRANS('ASSET_TAG');?>',1);
		return ok;
	}
...
<?php 
	...
	print "<TR>";
		print "<TD width='20%' align='left' bgcolor='".TD_COLOR."'>".TRANS('COL_UNIT').":</font></font></TD>";
	...
	print "<TR>";
		print "<TD width='20%' align='left' bgcolor='".TD_COLOR."'>".TRANS('ASSET_TAG').":</font></font></TD>";
		print "<TD width='30%' align='left' bgcolor='".BODY_COLOR."'>".
	...
	print "<TR>";
		...
		print "<TD align='center' bgcolor='".BODY_COLOR."'><input type='submit' class='button' value='".TRANS('SEARCH')."' name='ok'>";
		print "</TD>";
