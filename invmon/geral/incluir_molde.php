<?php 
  ...
  */session_start();
	...
	print "<TABLE border='0' colspace='3' width='100%'>";
		...
		print "<tr><td colspan='4'></td><b>".TRANS('GENERAL_DATA').":</b></td></tr>";
		print "<tr>";
...
// 					print " selected";
		...
		print "<TR>";
		print "<TD colspan='2'  align='right' bgcolor='".BODY_COLOR."'><input type='submit' value='".TRANS('BT_OK')."' name='submit' ".
