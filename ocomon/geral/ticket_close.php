...
if (!isset($_POST['submit'])) {
    ...
    /*     if ($_SESSION['s_nivel'] == 1) {
        $linkEdita = "<br><b><a href='altera_dados_ocorrencia.php?numero=" . $numero . "'>" . TRANS('FIELD_EDIT_FOR_ADMIN') . ":</a></b><br>";
    } else {
...
?>
    ...
    <div class="container-fluid">
        ...
        <h5 class="my-2"><i class="fas fa-check text-secondary"></i>&nbsp;<?= TRANS('SUBTTL_CLOSING_OCCO') . "&nbsp;<span class='badge badge-secondary pt-2'>" . $numero . "</span>"; ?></h5>
                ...
                <div class="form-group col-md-4">
                    <div id="idDivSelLocal">
                        <select class="form-control " name="local" required id="idLocal">
                            <option value="-1"><?= TRANS('SEL_SECTOR'); ?></option>
                            <?php
