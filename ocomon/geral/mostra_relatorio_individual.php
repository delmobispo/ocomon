...
print "<body>";
	...
	print "<BR><B>".TRANS('PRINT_TO_TREATING')."</B><BR>";

	print "<TABLE border='0' align='center' width='100%'>";
		print "<TR>";
		print "<hr>";
			print "<TD width='20%' align='left'><b>".TRANS('TICKET_NUMBER').":</b></TD>";
			print "<TD colspan='3' width='80%' align='left'>".$row['numero']."</TD>";
		print "</TR>";
		print "<TR>";
			print "<TD width='20%' align='left'><b>".TRANS('ISSUE_TYPE').":<b></TD>";
			print "<TD style=\"text-align:justify;\" width='30%' align='left'>".$row['problema']."</TD>";
			print "<TD width='20%' align='left'><b>".TRANS('SERVICE_AREA').":</b></TD>";
			print "<TD width='30%' align='left'>".$row['area']."</TD>";
		print "</TR>";
		print "<TR>";
			print "<TD width='20%' align='left' valign='top'><b>".TRANS('DESCRIPTION').":</b></TD>";
		...
		$i=0;
			while ($i < $linhas2)
			{
				...
				print "<TR>";
					print "<TD width='20%' align='left' valign='top'>".TRANS('TICKET_ENTRY')." ".$countAssentamento." de ".$linhas2." por ".
		...
		print "<TR>";
			print "<TD width='20%' align='left' valign='top'><b>".TRANS('COL_UNIT').":</b></TD>";
		...
		print "</TR>";
		print "<TR>";
			print "<TD width='20%' align='left'><b>".TRANS('FIELD_CONTACT').":</b></TD>";
			print "<TD width='30%' align='left'>".$row['contato']."</TD>";
			print "<TD width='20%' align='left'><b>".TRANS('COL_PHONE').":</b></TD>";
			print "<TD width='30%' align='left'>".$row['telefone']."</TD>";
		print "</tr>";
		print "<TR>";
			print "<TD width='20%' align='left'><b>".TRANS('DEPARTMENT').":</b></TD>";
			print "<TD width='30%' align='left'>".$row['setor']."</TD>";
			print "<TD width='20%' align='left'><b>".TRANS('TECHNICIAN').":</b></TD>";
		...
		{
			print "<TR>";
				print "<TD width='20%' align='left'><b>".TRANS('OPENING_DATE').":</b></TD>";
			...
			print "</tr>";
			print "<tr>";
				print "<TD width='20%' align='left'><b>".TRANS('COL_STATUS').":</b></TD>";
		...
		print "<TR>";
			...
			//print "<hr>";
				...
				print "<tr>";
					...
					print "<TD width='30%' align='left'>&nbsp;</TD>";
					print "<TD width='20%' align='left'>".TRANS('USER_SIGNATURE').":</TD>";
					print "<TD width='30%' align='left'>&nbsp;</TD>";
				print "</tr>";
			print "</TABLE>";
			print "<hr>";
