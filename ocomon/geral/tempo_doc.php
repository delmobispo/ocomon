...
print "<BODY bgcolor='".BODY_COLOR."'>";
	...
	print "<table cellspacing='0' border='1' cellpadding='1' align='left' width='100%'>";
		print "<tr><td width='20%'><b>".TRANS('TECHNICIAN')."</b></td><td width='20%'><b>".TRANS('OPENING')."</b></td><td width='20%'><b>".TRANS('EDITION')."</b></td><td width='20%'><b>".TRANS('COL_CLOSING')."</b></td><td width='20%'><b>".TRANS('TOTAL')."</b></td></tr>";
