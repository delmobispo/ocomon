...
print "<BODY bgcolor='".BODY_COLOR."'>";
	...
	print "<table cellspacing='0' border='1' cellpadding='1' align='left' width='100%'>";
		print "<tr><td width='20%'><b>".TRANS('DEPARTMENT').":</b></td><td width='30%'>".NVL($row['LOCAL'])."</td><td width='20%'><b>".TRANS('ISSUE_TYPE').":</b></td><td width='30%'>".NVL($row['problema'])."</td></tr>";
		print "<tr><td width='20%'><b>".TRANS('RESPONSE_SLA').":</b></td><td width='30%'>".NVL($row['resposta'])."</td><td width='20%'><b>".TRANS('SOLUTION_SLA').":</b></td><td width='30%'>".NVL($row['solucao'])."</td></tr>";
	print "</table>";
