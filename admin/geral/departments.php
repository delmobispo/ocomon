...
<body>
	...
	<div class="container-fluid">
		<h4 class="my-4"><i class="fas fa-address-card text-secondary"></i>&nbsp;<?= TRANS('DEPARTMENTS'); ?></h4>
		...
		?>
			...
			<?= TRANS('MANAGE_RELATED_ITENS'); ?>:&nbsp;<button class="btn btn-sm btn-success manage" data-location="buildings" name="buildings"><?= TRANS('MANAGE_BUILDINGS'); ?></button>
			<button class="btn btn-sm btn-success manage" data-location="rectories" name="probtp2"><?= TRANS('MANAGE_RECTORIES'); ?></button>
			<button class="btn btn-sm btn-success manage" data-location="domains" name="probtp3"><?= TRANS('MANAGE_DOMAINS'); ?></button>
			<br /><br />
			<?php
			if ($registros == 0) {
				...
				<table id="table_lists" class="stripe hover order-column row-border" border="0" cellspacing="0" width="100%">
					...
					<thead>
						<tr class="header">
							...
							<td class="line priority"><?= TRANS('COL_PRIORITY'); ?></td>
					...
					<tbody>
						...
						foreach ($resultado->fetchall() as $row) {
							...
							<tr>
								...
								<td class="line"><?= $row['prioridade']; ?></td>
		...
		if ((isset($_GET['action'])  && ($_GET['action'] == "new")) && !isset($_POST['submit'])) {
			...
			<form method="post" action="<?= $_SERVER['PHP_SELF']; ?>" id="form">
				...
				<div class="form-group row my-4">
					...
					<div class="form-group col-md-10">
						<div class="input-group">
							<select class="form-control" name="rectory" id="rectory" required>
								<option value="-1" selected><?= TRANS('SEL_MAJOR'); ?></option>
								<?php
                    ...
                    <label for="response_level" class="col-md-2 col-form-label col-form-label-sm text-md-right"><?= TRANS('TXT_PRIORITY_RESP'); ?></label>
					<div class="form-group col-md-10">
							...
							<select class="form-control" name="response_level" id="response_level" required>
								...
								?>
									<option value='<?= $rowPrior['prior_cod']; ?>'><?= $rowPrior['prior_nivel']; ?></option>
								<?php
								}
								?>
							</select>
