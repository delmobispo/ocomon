...
//         	"</TD><br><BR>";
        ...
        else
        {
			...
			print "<TR class='header'><td>".TRANS('DIRECTIVE')."</TD><td>".TRANS('OPT_VALOR')."</TD></TD></tr>";
			print "<tr><td colspan='2'>&nbsp;</td></tr>";
			print "<tr><td>".TRANS('OPT_ALLOW_USER_OPEN')."</td><td>".transbool($row['conf_user_opencall'])."</td></tr>";
			print "<tr><td>".TRANS('SELF_REGISTER_AREA')."</td><td>".$row['ownarea']."</td></tr>";
			print "<tr><td>".TRANS('OPT_AREA_USER_OPENTO')."</td><td>".$row['sistema']."</td></tr>";
			print "<tr><td colspan='2'>&nbsp;</td></tr>";
			print "<tr><td colspan='2'><b>".TRANS('OPT_TTL_CUSTON_OPEN').":</b></td></tr>";
			//print "<tr><td>".TRANS('CUSTOM_SCREEN_AREAS')."</td><td>".$listAreas."</td></tr>";
			print "<tr><td>".TRANS('FIELD_AREA')."</td><td>".transbool($row['conf_scr_area'])."</td></tr>";
			print "<tr><td>".TRANS('FIELD_TYPE_OF_PROBLEM')."</td><td>".transbool($row['conf_scr_prob'])."</td></tr>";
			print "<tr><td>".TRANS('FIELD_DESCRIPTION')."</td><td>".transbool($row['conf_scr_desc'])."</td></tr>";
			print "<tr><td>".TRANS('FIELD_UNIT')."</td><td>".transbool($row['conf_scr_unit'])."</td></tr>";
			print "<tr><td>".TRANS('ASSET_TAG')."</td><td>".transbool($row['conf_scr_tag'])."</td></tr>";
			...
			print "<tr><td>".TRANS('FIELD_CONTACT')."</td><td>".transbool($row['conf_scr_contact'])."</td></tr>";
			print "<tr><td>".TRANS('FIELD_PHONE')."</td><td>".transbool($row['conf_scr_fone'])."</td></tr>";
			print "<tr><td>".TRANS('FIELD_DEPARTMENT')."</td><td>".transbool($row['conf_scr_local'])."</td></tr>";
			print "<tr><td>".TRANS('BUTTON_LOAD_DEPARTMENT')."</td><td>".transbool($row['conf_scr_btloadlocal'])."</td></tr>";
			print "<tr><td>".TRANS('OPT_SCH_LOCAL')."</td><td>".transbool($row['conf_scr_searchbylocal'])."</td></tr>";
			print "<tr><td>".TRANS('FIELD_OPERATOR')."</td><td>".transbool($row['conf_scr_operator'])."</td></tr>";
			print "<tr><td>".TRANS('FIELD_DATE')."</td><td>".transbool($row['conf_scr_date'])."</td></tr>";
			print "<tr><td>".TRANS('FIELD_SCHEDULE')."</td><td>".transbool($row['conf_scr_schedule'])."</td></tr>";
			print "<tr><td>".TRANS('FIELD_FORWARD')."</td><td>".transbool($row['conf_scr_foward'])."</td></tr>";
			print "<tr><td>".TRANS('FIELD_STATUS')."</td><td>".transbool($row['conf_scr_status'])."</td></tr>";

			print "<tr><td>".TRANS('FIELD_ATTACH_FILE')."</td><td>".transbool($row['conf_scr_upload'])."</td></tr>";

			print "<tr><td>".TRANS('FIELD_REPLICATE')."</td><td>".transbool($row['conf_scr_replicate'])."</td></tr>";
			print "<tr><td>".TRANS('FIELD_PRIORITY')."</td><td>".transbool($row['conf_scr_prior'])."</td></tr>";
			print "<tr><td>".TRANS('FIELD_SEND_EMAIL')."</td><td>".transbool($row['conf_scr_mail'])."</td></tr>";
	...
	if ((isset($_GET['action']) && ($_GET['action']=="alter")) && empty($_POST['submit'])){
		...
		print "<tr><td colspan='2'>&nbsp;</td></tr>";
		print "<tr><td colspan='2'><b>".TRANS('AVAILABLE_FIELDS_IN_OPENING_SCREEN').":</b></td></tr>";
		print "<tr><td colspan='2'>&nbsp;</td></tr>";

		print "<tr><td>".TRANS('FIELD_AREA')."</td><td>";
		...
		print "<tr><td>".TRANS('FIELD_TYPE_OF_PROBLEM')."</td><td>";
		...
		print "<tr><td>".TRANS('FIELD_DESCRIPTION')."</td><td>";
		...
		print "<tr><td>".TRANS('FIELD_UNIT')."</td><td>";
		...
		print "<tr><td>".TRANS('ASSET_TAG')."</td><td>";
		...
		print "<tr><td>".TRANS('FIELD_CONTACT')."</td><td>";
		...
		print "<tr><td>".TRANS('FIELD_PHONE')."</td><td>";
		...
		print "<tr><td>".TRANS('FIELD_DEPARTMENT')."</td><td>";
		...
		print "<tr><td>".TRANS('BUTTON_LOAD_DEPARTMENT')."</td><td>";
		...
		print "<tr><td>".TRANS('FIELD_SCHEDULE')."</td><td>";
		...
		print "<tr><td>".TRANS('FIELD_FORWARD')."</td><td>";
		...
		print "<tr><td>".TRANS('FIELD_ATTACH_FILE')."</td><td>";//.transbool($row['conf_scr_replicate'])."</td></tr>";
		...
		print "<tr><td>".TRANS('FIELD_PRIORITY')."</td><td>";//.transbool($row['conf_scr_replicate'])."</td></tr>";
	...
	if ($_POST['submit'] = TRANS('BT_ALTER')){
		...
		//print $qry;
		//exit;
		$exec= mysql_query($qry) or die(TRANS('MSG_ERR_DATA_UPDATE'));
...
// 		}
		...
		print "<script>mensagem('".TRANS('MSG_SUCCESS_EDIT','',0)."'); redirect('screenprofiles.php');</script>";
	}
?>
