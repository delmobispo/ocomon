...
<?php
	...
	<div class="container-fluid">
		<h4 class="my-4"><i class="fas fa-tags text-secondary"></i>&nbsp;<?= TRANS('PROBLEM_TYPES_CATEGORIES'); ?>&nbsp;<span class="badge badge-secondary"><?= $row_config['conf_prob_tipo_2']; ?></span></h4>
